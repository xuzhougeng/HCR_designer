...
def create_primer(seq, prefix, probe_size=50, polyN=5, 
                  ...
                  min_tm=45, max_tm=55, 
                  initiator_type: str = "B1", kmer:int = 8):
    
    inner_gap = probe_size - HCR_EVEN_PROBE_SIZE - HCR_ODD_PROBE_SIZE
    
    probes = create_probes(seq, probe_size, inner_gap=inner_gap, polyN=polyN, min_gc=min_gc, max_gc=max_gc, min_tm=min_tm, max_tm=max_tm,k=kmer)
