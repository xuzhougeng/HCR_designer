from scripts.hcr import create_primer
...
"""探针结构
L: L +  TCTCGTTTTCTGAACTTAGC[anchor sequence] + CGGTATCAAG
R: CTGTTTAAGA + [Bridge Probe] + R
"""
...
def process_gene(gene, bridge_seq_dict, cdna_dict, blast_db):
    ...
    # 保存探针结果
    probe_df.to_csv(output_file, sep='\t', index=False)
